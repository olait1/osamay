...
@if ( $chat->user_id == auth()->guard('parents')->user()->id)



                            <div class="d-flex  float-right  bd-highlight" style="width:60% ">
								<div class="img_cont">
									<img src="{{asset('storage/'.auth()->guard('parents')->user()->passport)}}" title="You" class="rounded-circle user_img">
...
<div class="d-flex bd-highlight" style="width:100% ">
    ...
    <div class="user_info " style="width:100% ">
        ...
        <p>{{$chat->user->name}} left 7 mins ago</p>
    </div>
</div>
...
<div class="d-flex bd-highlight" style="width:100% ">
    ...
    <div class="user_info " style="width:100% ">
        <span class=" bg-primary p-3 text-light w-50  rounded">{{$chat->message}}</span>
        <p>{{$chat->user->name}} left 7 mins ago</p>
    </div>
</div>
...
<div class="d-flex bd-highlight" style="width:100% ">
    ...
    <div class="user_info " style="width:100% ">
        ...
        <p>{{$chat->parents->p_name}} left 7 mins ago</p>
    </div>
</div>
...
@endif
                  ...
                  <div class="row mt-5" style=" bottom:10px;">
                    <div class="row mt-5  mb-0  p-3" style="position:fixed; bottom:0px;background:#15283c; ">
                        ...
                        <form action="{{route('parent.generalChatroom')}}" method="post">
                            @csrf
