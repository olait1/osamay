                        ...
                        <div class="col-md-8 ">
                           ...
                           <div class="row mt-4  mx-auto">
                            <div class="col-md-3 bg-primary mx-2 p-3  rounded text-white text-center">
                                <h4 class="text-light">Admission No</h4>
                                <h5 class="text-warning">{{auth()->user()->student_id->student_id}}</h5>
                            </div>
                            <div class="col-md-3 bg-warning mx-2 rounded text-center p-3">
                                 <h4 class="text-light">Gender</h4>
                                <h5 class="text-primary">{{auth()->user()->gender}}</h5></div>
                            <div class="col-md-3 bg-success mx-2 rounded text-center p-3">
                                <h4 class="text-light">Level</h4>

                                <h5 class="text-warning">{{auth()->user()->student_id->classes->class_name}}</h5>
                                </div>
                           </div>
